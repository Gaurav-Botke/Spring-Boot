...
public class BootProj14RealtimeDIStrategyDPProfilesWithYMLApplication {  
	...
	SpringApplication app =	new  SpringApplication(BootProj14RealtimeDIStrategyDPProfilesWithYMLApplication.class);
	//set the profile
